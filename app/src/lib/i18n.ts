...
export const messages: Record<AppLanguage, AppMessages> = {
  en: {
    ...
    settings: {
      ...
      keyConfigured: 'Stored in the system credential manager',
      keyNotConfigured: 'No API key stored; local services may not require one',
      saveKey: 'Save key',
      clearKey: 'Clear key',
    ...
    ai: {
      ...
      disabled: 'Configure and enable AI before sending a request.',
      context: 'Context',
      selection: 'Selection',
      paragraph: 'Paragraph',
      note: 'Current note',
      promptPlaceholder: 'Ask about the current note...',
      send: 'Send',
      thinking: 'Working...',
      ...
      sources: 'Sources',
      staleContext: 'The note changed. Choose an insertion action or copy the result.',
  ...
  zh: {
    ...
    settings: {
      ...
      keyConfigured: '已保存在系统凭据管理器中',
      keyNotConfigured: '尚未保存 API Key；本地服务可能不需要',
      saveKey: '保存 Key',
      clearKey: '清除 Key',
      testConnection: '测试连接',
    ...
    ai: {
      ...
      close: '关闭',
      configure: '打开 AI 设置',
      disabled: '请先配置并启用 AI，再发送请求。',
      context: '上下文',
      selection: '选中内容',
      paragraph: '当前段落',
      note: '当前笔记',
      promptPlaceholder: '围绕当前笔记提问……',
      send: '发送',
      thinking: '处理中……',
      replace: '替换上下文',
      ...
      sources: '参考',
      staleContext: '笔记内容已经变化，请选择插入或复制结果。',
      inserted: '已插入 AI 结果',
      replaced: '已替换 AI 上下文',
      shortcutHint: 'Ctrl+K',
