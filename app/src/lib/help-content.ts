  ...
  if (topic === 'ai') {
    return {
      ...
      lines: zh ? [
        ...
        '## 5. \u63d0\u793a\u8bcd\u5e93',
        '\u70b9\u51fb Ctrl+K \u8f93\u5165\u6846\u5de6\u4e0b\u89d2\u7684 +\uff0c\u53ef\u5f15\u7528\u63d0\u793a\u8bcd\u5e93\u4e2d\u7684 Markdown \u6587\u4ef6\u3002\u6309 F4 \u53ef\u65b0\u5efa\u76ee\u5f55\u3001\u62d6\u62fd\u6587\u4ef6\u6216\u6574\u4e2a\u76ee\u5f55\u8fdb\u884c\u5206\u7c7b\uff0c\u53f3\u952e\u76ee\u5f55\u53ef\u91cd\u547d\u540d\u6216\u5c06\u5176\u5185\u5bb9\u79fb\u5165\u56de\u6536\u7ad9\uff1b\u70b9\u51fb\u63d0\u793a\u8bcd\u540e\u4f1a\u5728\u4e3b\u7f16\u8f91\u5668\u4e2d\u4f5c\u4e3a\u7279\u6b8a\u6807\u7b7e\u9875\u6253\u5f00\u3002\u63d0\u793a\u8bcd\u4fdd\u5b58\u5728 ~/.neopad/prompts/**/*.md\uff0c\u4e0e\u7b14\u8bb0\u5185\u5bb9\u5206\u5f00\u7ba1\u7406\u3002',
        '## 6. \u9690\u79c1\u4e0e\u6570\u636e\u8303\u56f4',
        ...
        '## 5. Prompt library',
        'Use the + button in Ctrl+K to attach a Markdown prompt. Press F4 to create folders and organize prompts or complete folder trees by drag and drop. Right-click a folder to rename it or move its contents to Trash. Prompts can also be duplicated, renamed, trashed, restored, or opened as marked tabs in the main editor. Prompt files stay under ~/.neopad/prompts/**/*.md and remain separate from notes.',
