  ...
  return [
    ...
    },
    {
      ...
      rows: [
        ...
        { keys: 'Ctrl+W', description: zh ? '\u5173\u95ed\u5f53\u524d\u6807\u7b7e\u9875\uff08\u4e0d\u5220\u9664\u7b14\u8bb0\uff09' : 'Close the current tab without deleting its note' },
        { keys: 'Alt+Del', description: zh ? '\u5c06\u5f53\u524d\u7b14\u8bb0\u79fb\u5165\u56de\u6536\u7ad9' : 'Move the current note to Trash' },
        { keys: 'F4', description: zh ? '\u663e\u793a/\u9690\u85cf\u7b14\u8bb0\u6d4f\u89c8\u5668' : 'Show or hide the note browser' },
...
export function getHelpContent(topic: HelpTopic | null, language: AppLanguage, context: HelpContext) {
  ...
  if (topic === 'ai') {
    return {
      ...
      lines: zh ? [
        ...
        '## 5. \u63d0\u793a\u8bcd\u5e93',
        '\u70b9\u51fb Ctrl+K \u8f93\u5165\u6846\u5de6\u4e0b\u89d2\u7684 +\uff0c\u53ef\u5f15\u7528\u63d0\u793a\u8bcd\u5e93\u4e2d\u7684 Markdown \u6587\u4ef6\u3002\u63d0\u793a\u8bcd\u4fdd\u5b58\u5728 ~/.neopad/prompts/*.md\uff0c\u4e0e\u7b14\u8bb0\u5185\u5bb9\u5206\u5f00\u7ba1\u7406\u3002',
        '## 6. \u9690\u79c1\u4e0e\u6570\u636e\u8303\u56f4',
        ...
        '## 5. Prompt library',
        'Use the + button in the Ctrl+K composer to reference Markdown prompts stored under ~/.neopad/prompts/*.md. Prompt files remain separate from notes.',
  ...
  return {
    ...
    lines: zh ? [
      ...
      '## 4. \u67e5\u627e\u3001\u6574\u7406\u4e0e\u63d0\u9192',
      'Ctrl+F \u67e5\u627e\u5f53\u524d\u7b14\u8bb0\uff0cCtrl+Shift+F \u641c\u7d22\u6574\u4e2a NeoPad \u5de5\u4f5c\u533a\uff0cF4 \u6253\u5f00\u7b14\u8bb0\u6d4f\u89c8\u5668\u7ba1\u7406\u6d3b\u8dc3\u3001\u5f52\u6863\u548c\u56de\u6536\u7ad9\u5185\u5bb9\u3002Ctrl+E \u63d2\u5165\u63d0\u9192\uff0cF6 \u67e5\u770b\u63d0\u9192\u5217\u8868\uff1bNeoPad \u8fd0\u884c\u65f6\u53ef\u53d1\u9001\u7cfb\u7edf\u901a\u77e5\u3002',
      '## 5. \u5feb\u901f\u91c7\u96c6\u4e0e\u6587\u4ef6\u4ea4\u6362',
      ...
      'Use Ctrl+F in the current note, Ctrl+Shift+F across the NeoPad workspace, and F4 to manage active, archived, and trashed notes. Ctrl+E inserts a reminder and F6 opens the reminder list; NeoPad can notify you while it is running.',
