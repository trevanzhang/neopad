  ...
  if (topic === 'ai') {
    return {
      ...
      lines: zh ? [
        ...
        '## 5. \u63d0\u793a\u8bcd\u5e93',
        '\u70b9\u51fb Ctrl+K \u8f93\u5165\u6846\u5de6\u4e0b\u89d2\u7684 +\uff0c\u53ef\u5f15\u7528\u63d0\u793a\u8bcd\u5e93\u4e2d\u7684 Markdown \u6587\u4ef6\u3002\u6309 F4 \u53ef\u65b0\u5efa\u3001\u590d\u5236\u3001\u91cd\u547d\u540d\u3001\u5220\u9664\u548c\u6062\u590d\u63d0\u793a\u8bcd\uff1b\u70b9\u51fb\u540e\u4f1a\u5728\u4e3b\u7f16\u8f91\u5668\u4e2d\u4f5c\u4e3a\u7279\u6b8a\u6807\u7b7e\u9875\u6253\u5f00\u3002\u63d0\u793a\u8bcd\u4fdd\u5b58\u5728 ~/.neopad/prompts/*.md\uff0c\u4e0e\u7b14\u8bb0\u5185\u5bb9\u5206\u5f00\u7ba1\u7406\u3002',
        '## 6. \u9690\u79c1\u4e0e\u6570\u636e\u8303\u56f4',
        ...
        '## 5. Prompt library',
        'Use the + button in Ctrl+K to attach a Markdown prompt. Press F4 to create, duplicate, rename, trash, restore, or open prompts as marked tabs in the main editor. Prompt files stay under ~/.neopad/prompts/*.md and remain separate from notes.',
