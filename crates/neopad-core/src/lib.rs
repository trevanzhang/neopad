...
pub use note::{
    ...
    list_searchable_notes, open_note, read_note, reconcile_note_metadata, rename_note,
    set_note_color, unarchive_note, write_note_atomic, write_note_atomic_checked, NoteContent,
};
pub use reminder::{
