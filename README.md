...
- `Ctrl+O`, dragging `.md` or `.markdown` files onto the window, or opening an
  ...
  narrower mobile-sharing layout available for phone viewing. PNG and PDF
  exports follow the current preview theme and typography, and PDF pages carry
  the theme background through the full page. Exported PNG and PDF output ends
  with a `Powered by NeoPad` footer. PNG and PDF actions are available from
